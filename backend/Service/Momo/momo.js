module.exports = function (responseS) {
  ...
  this.SendMoMo = function (
    ...
    var returnUrl = "https://00706e4d1128.ngrok.io/thanhtoanmomo"; //front end
    var notifyurl = "https://e534ef95e58b.ngrok.io/api/frontend/thanhtoanmomo"; /// backend
    ...
    var extraData =
      ...
      IDLopHoc +
      ";IDHocVien=" +
      IDHocVien; //"merchantName=;merchantId=" //pass empty value if your merchant does not have stores else merchantName=[storeName]; merchantId=[storeId] to identify a transaction map with a physical store
    ...
    var req = https.request(options, (res) => {
      ...
      res.on("data", (body) => {
        ...
        let NoiDung =
          "Đăng kí lớp học thành công. Nhưng thanh toán thất bại. Vui lòng liên hệ trung tâm để được hỗ trợ";
